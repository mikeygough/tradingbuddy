...
pdf.cell(w=40, h=10, txt='Close: {}'.format(CLOSE),
         border=0, ln=1, align='',
         fill=False, link='')

# print('high', HIGH)
pdf.cell(w=40, h=10, txt='Period High: {}'.format(HIGH),
    ln=1)

# print('low', LOW)
pdf.cell(w=40, h=10, txt='Period Low: {}'.format(LOW),
    ln=1)

# print('return', RETURN)
pdf.cell(w=40, h=10, txt='Return: {}'.format(RETURN),
    ln=1)

# print('one_sd', ONE_SD)
pdf.cell(w=40, h=10, txt='One Sd.: {}'.format(ONE_SD),
    ln=1)
...
# print('historical_vol', HISTORICAL_VOL)
pdf.cell(w=40, h=10, txt='Historical Volatility: {}'.format(HISTORICAL_VOL),
    ln=1)

# print('one day upper range', UPPER_1)
pdf.cell(w=40, h=10, txt='Upper 1: {}'.format(UPPER_1),
    ln=1)

# print('two day upper range', UPPER_2)
pdf.cell(w=40, h=10, txt='Upper 2: {}'.format(UPPER_2),
    ln=1)

# print('three day upper range', UPPER_3)
pdf.cell(w=40, h=10, txt='Upper 3: {}'.format(UPPER_3),
    ln=1)

# print('four day upper range', UPPER_4)
pdf.cell(w=40, h=10, txt='Upper 4: {}'.format(UPPER_4),
    ln=1)

# print('five day upper range', UPPER_5)
pdf.cell(w=40, h=10, txt='Upper 5: {}'.format(UPPER_5),
    ln=1)

# print('one day lower range', LOWER_1)
pdf.cell(w=40, h=10, txt='Lower 1: {}'.format(LOWER_1),
    ln=1)

# print('two day lower range', LOWER_2)
pdf.cell(w=40, h=10, txt='Lower 2: {}'.format(LOWER_2),
    ln=1)

# print('three day lower range', LOWER_3)
pdf.cell(w=40, h=10, txt='Lower 3: {}'.format(LOWER_3),
    ln=1)

# print('four day lower range', LOWER_4)
pdf.cell(w=40, h=10, txt='Lower 4: {}'.format(LOWER_4),
    ln=1)

# print('five day lower range', LOWER_5)
pdf.cell(w=40, h=10, txt='Lower 5: {}'.format(LOWER_5),
    ln=1)


pdf.cell(60, 10, txt='Powered by FPDF.', border=0, ln=1, align='C')
